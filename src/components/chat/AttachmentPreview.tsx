...
export const AttachmentPreview: React.FC<AttachmentPreviewProps> = ({ attachments, onRemove }) => {
  ...
  return (
    <div className="flex flex-wrap gap-2 px-4 py-2 border-t border-[rgba(255,255,255,0.06)] bg-[#0f0f11]/60">
      {attachments.map((att) => (
        <div
          key={att.id}
          className="relative flex h-14 w-14 items-center justify-center rounded-lg border border-zinc-700 bg-zinc-900 overflow-hidden group shadow-sm select-none"
        >
